...
import com.hughswb.blog.annotation.OptLog;
...
import com.hughswb.blog.strategy.context.ArticleImportStrategyContext;
...
import static com.hughswb.blog.constant.OptTypeConst.*;
...
public class ArticleController {
     ...
     * @return {@link Result<>}
     */
    @ApiOperation(value = "时间线数据")
    @GetMapping("/admin/articles/articleTimeline/{cateGoryId}")
    public Result<?> articleTimeline(@PathVariable("cateGoryId") Integer cateGoryId) {
        return Result.ok(articleService.articleTimeline(cateGoryId));
    }
